...
import 'package:watertracker/screens/register_screen.dart';
...
import 'package:watertracker/screens/main_screen.dart'; // Added MainScreen import
    ...
    try {
      ...
      if (user != null && mounted) {
        ...
        if (user['needsRegistration'] == true) {
          // New Google user - show error, don't auto-register
          NotificationService().showInAppNotification(context, NotificationType.loginFailed);
        } else {
          // Existing user - login successful
          NotificationService().showInAppNotification(context, NotificationType.loginSuccess);
  ...
  void _handleLogin() async {
    ...
    try {
      ...
      if (user != null && mounted) {
        ...
        // Delay navigation slightly to show notification
        Future.delayed(const Duration(seconds: 1), () {
          if (mounted) {
            Navigator.pushReplacement(
              context,
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          localized.translate('dontHaveAccount') + ' ',
          ...
          suffixIcon: isPassword
              ? IconButton(
                  icon: SvgPicture.asset(
                    obscureText
                        ? 'assets/images/btn_menutup.svg'
                        : 'assets/images/btn_melihat.svg',
                    // Consider colorFilter for dark mode if icons are black
